...
class Up_Dconv(torch.nn.Module):
    def __init__(self,in_channel,middle_channel,out_channel):
        ...
        self.deconv = torch.nn.ConvTranspose2d(in_channel,middle_channel,kernel_size=2,stride=2)
        self.Dconv = Double_Conv(in_channel + middle_channel,out_channel)
...
class Up_Tconv(torch.nn.Module):
    def __init__(self,in_channel,middle_channel,out_channel):
        ...
        self.deconv = torch.nn.ConvTranspose2d(in_channel,middle_channel,kernel_size=2,stride=2)
        self.Tconv = Triple_Conv(in_channel + middle_channel,out_channel)
